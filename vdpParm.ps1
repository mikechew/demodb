## File: .\vdpSampleParam.ps1
## Purpose: Sets the parameters required for the ManageDB.ps1 v 1.1 PowerShell script
...
### Oracle database related parameters 
## 
[string] $src_appname = "JPMCSA"          ## Source application name - database name
[string] $src_hostname = "jpmc-ora01"       ## Source hostname - where did we captured from?
[string] $tgt_hostname = "jpmc-ora01"       ## Mounted to which host?
...
[string] $tgt_tnsorahome = "/u01/app/oracle/network/admin"    ## Oracle Home Directory  /u01/oracle/product/12.1.0.2
